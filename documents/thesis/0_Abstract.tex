\begin{abstract}
    ...
    For reasoning about effect handlers there exists the ML-like language \hh{} and an associated separation logic called \hazel{}, built on top of the Iris framework.
