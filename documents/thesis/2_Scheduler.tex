...
If \(p\) is still unfulfilled the first time \(await\) checks the promise state, it will call \(make\_register\) to create a \ocamlin{register} function in order to perform the \esuspend{} effect.
...
\begin{mathpar}
  ...
  { \gsIsPr{}\; p\; \Phi \ast \gsIsCQS{}\; cqs }
  { \ewp{make\_register\; p\; cqs}{\bot}{reg,\; \isreg{}\; reg\; (\lambda\; v,\; \ulcorner v = () \urcorner \ast \gspdone{})}}
