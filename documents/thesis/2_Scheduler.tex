...
It defines a \ocamlin{register} function that registers the \ocamlin{waker} function with CQS by using \ocamlin{CQS.register}.
...
Right after the state is read in line 21 another thread might change the state to \ocamlin{Done} and go on to call \ocamlin{CQS.signal_all}.
