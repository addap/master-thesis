...
As long as the promise is not fulfilled we own a broadcast\todo{Establish \emph{broadcast} as a name for \ocamlin{CQS}}, one copy of \gspwait{}, and a \gssignal{}.
...
\begin{mathpar}
  ...
  { \ewp{CQS.register\; cqs\; callback}{\bot}{r,\; \emph{isCQSRegisterResult}\; r\; callback\; R}}

  \and

  \inferrule[Spec-CQSTryCancel]
  { \emph{isCQSRegisterHandle}\; h\; callback\; R }
