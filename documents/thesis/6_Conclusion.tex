...
The effect handler (implemented by a library such as Eio) must then create a \ocamlin{waker} function and assign it to the trigger.\todo{mention resemblance to Landin's Knot?}
