...
\newcommand{\protod}{\textit{Coop}~\ensuremath{\delta}}
\newcommand{\gsIsReg}{\textit{isRegister}}
\newcommand{\gsIsWaker}{\textit{isWaker}}
\newcommand{\gsIsCb}{\textit{isCallback}}
\NewDocumentCommand\ewp{O{} m O{} m m}%
  {\mathit{ewp}^{#1}_{#3}\spac\left(#2\right)\spac\left\langle#4\right\rangle\spac{\left\{#5\right\}}}
\newcommand{\ewpt}{\textit{ewp}}
\newcommand{\gsReady}{\textit{Ready}}
\newcommand{\gsPState}{\textit{PromiseState}}
\newcommand{\gsPInvIn}{\textit{PInvInner}}
\newcommand{\gsPInv}{\textit{PromiseInv}}
\newcommand{\invN}{\ensuremath{\mathcal{N}}}
\newcommand{\gsIsPr}{\textit{isPromise}}
\newcommand{\gsIsQueue}{\textit{isQueue}}
\newcommand{\gsIsCQS}{\textit{isCQS}}
\newcommand{\gspwait}{\textit{promiseWaiting}~\ensuremath{\gamma}}
\newcommand{\gspdone}{\textit{promiseDone}~\ensuremath{\gamma}}
\newcommand{\gssignal}{\textit{signalAllPermit}}
